...
export async function GET(request: NextRequest) {
  try {
    ...
    const supabaseUrl = process.env[supabaseUrlKey] || process.env.NEXT_PUBLIC_SUPABASE_URL
    const anonKey = process.env[supabaseAnonKeyName] || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY
