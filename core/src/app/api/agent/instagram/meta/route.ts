...
async function handleComment(value: any, ourIgId: string, supabase: any): Promise<void> {
  ...
  try {
    const input: AgentInput = {
      channel: 'social',
      message: text || 'Hi, I saw your post and I am interested in pilot training.',
      messageCount: 0,
  ...
  await sendInstagramCommentReply(commentId, "Thanks for reaching out! Just sent you a DM 🛩️").catch(() => {});
}
