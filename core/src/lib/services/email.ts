 ...
 *   RESEND_FROM_EMAIL     e.g. "team@send.windchasers.in" (defaults to Resend sandbox)
  ...
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;color:#1a1a1a;line-height:1.6">
    ...
    <p style="margin:0 0 24px">
      <a href="${opts.inviteUrl}"
         style="display:inline-block;padding:12px 24px;background:#0066ff;color:#fff;text-decoration:none;border-radius:6px;font-weight:600">
        Accept invitation
      </a>
    </p>
    ...
    <p style="margin:0 0 24px;font-size:13px;word-break:break-all">
      <a href="${opts.inviteUrl}" style="color:#0066ff">${opts.inviteUrl}</a>
    </p>
