-- Fix unified_leads view to ensure it works with RLS
-- This migration ensures the view can see all leads from all_leads table
...
-- Ensure the view owner has proper permissions
