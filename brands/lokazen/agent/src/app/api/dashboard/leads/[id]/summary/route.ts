...
async function buildLokazenSummaryResponse(
  ...
  const brandFields = [
    ...
    fieldLine('Location details', lkz.location_details),
    fieldLine('Locality', lkz.locality),
    fieldLine('City', lkz.city),
    fieldLine('State', lkz.state),
    fieldLine('Pincode', lkz.pincode),
  ...
  const ownerFields = [
    ...
    fieldLine('Address', lkz.property_address),
    fieldLine('Location details', lkz.location_details),
    fieldLine('Locality', lkz.locality),
    fieldLine('City', lkz.city),
    fieldLine('State', lkz.state),
    fieldLine('Pincode', lkz.pincode),
    fieldLine('Coordinates', lkz.coordinates),
    fieldLine('Maps', lkz.google_maps_url),
