...
import { MdCall, MdPsychology, MdViewKanban, MdAutorenew, MdArrowBack } from 'react-icons/md'
import Link from 'next/link'

type FlagKey = 'voice' | 'brain' | 'pipelineFunnel' | 'followUpSequence'
...
const FEATURES: Array<{ key: FlagKey; name: string; desc: string; icon: React.ComponentType<{ size?: number }>; live: boolean }> = [
  ...
  { key: 'pipelineFunnel', name: 'Pipeline Funnel', desc: 'The funnel-stage breakdown widget on the Pipeline page.', icon: MdViewKanban, live: false },
