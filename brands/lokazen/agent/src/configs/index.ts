...
import { lokazenConfig } from './lokazen.config';
...
function detectBrandFromHostname(): string | null {
  ...
  if (host.includes('lokazen')) return 'lokazen';
  return null;
}
...
export { proxeConfig, windchasersConfig, bconConfig, lokazenConfig };
