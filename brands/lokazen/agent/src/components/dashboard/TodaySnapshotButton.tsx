                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      {/* Lead type — Brand (seeking space) vs Owner (listing) */}
                      {data.leads.byType && (
                        <div className="mt-3 pt-2.5 border-t space-y-1" style={{ borderColor: 'var(--border-primary)' }}>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-[11px]" style={{ color: 'var(--text-primary)' }}>Brand Owner</span>
                            <span className="text-[11px] font-semibold tabular-nums" style={{ color: '#a5b4fc' }}>{data.leads.byType.Brand || 0}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-[11px]" style={{ color: 'var(--text-primary)' }}>Property Owner</span>
                            <span className="text-[11px] font-semibold tabular-nums" style={{ color: '#22c55e' }}>{data.leads.byType.Owner || 0}</span>
                          </div>
                        </div>
                      )}
                    </section>
