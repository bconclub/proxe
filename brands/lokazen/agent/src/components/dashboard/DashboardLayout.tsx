...
// Brand identity (name + logo) resolved from env at module load — no hardcoded brand.
const BRAND = getBrandConfig()
const BRAND_NAME = BRAND.name
const BRAND_LOGO = BRAND.chatStructure?.avatar?.source || '/logo.png'
    ...
    <div className="dashboard-layout min-h-screen" style={{ backgroundColor: 'var(--bg-primary)', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          ...
          <h1 className="text-xl font-black" style={{ color: 'var(--accent-primary)' }}>{BRAND_NAME}</h1>
        </div>
