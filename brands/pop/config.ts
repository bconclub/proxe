...
export const popConfig: BrandConfig = {
  ...
  artifacts: [
    ...
    },
    {
      ...
      icon: 'megaphone',
      features: [
        { name: 'AI chatbot (web widget)', status: 'live' },
        { name: 'Raise issue (grievance intake)', status: 'live' },
        { name: 'Become volunteer (intensity climbs automatically)', status: 'live' },
        { name: 'Give feedback', status: 'live' },
        { name: 'Join campaign', status: 'wip' },
        { name: 'WhatsApp opt-in', status: 'wip' },
        { name: 'Events + RSVPs', status: 'planned' },
        { name: 'Polls', status: 'planned' },
        { name: 'Surveys', status: 'planned' },
        { name: 'Local news', status: 'planned' },
        { name: 'Voice messages', status: 'planned' },
        { name: 'Donate (gateway TBD)', status: 'planned' },
      ],
    },
    {
      id: 'listen',
