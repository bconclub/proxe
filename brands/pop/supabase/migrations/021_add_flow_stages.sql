...
-- Drop the 3-arg version from 000_master_schema so the 6-arg version below is
-- the ONLY determine_lead_stage. Otherwise both overloads coexist and any 3-arg
-- call (and the bare COMMENT ON FUNCTION below) is ambiguous = "not unique".
DROP FUNCTION IF EXISTS determine_lead_stage(INTEGER, BOOLEAN, BOOLEAN);
