-- Migration: Ensure unified_leads view includes lead_score and lead_stage fields
-- This migration ensures the view always includes scoring fields even if they were missing
...
SELECT 
  ...
  -- Lead scoring fields (ensure they're always included)
