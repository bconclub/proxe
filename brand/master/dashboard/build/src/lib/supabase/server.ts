...
export async function createClient() {
  ...
  const hasUrl = !!process.env.NEXT_PUBLIC_BRAND_SUPABASE_URL
  const hasKey = !!process.env.NEXT_PUBLIC_BRAND_SUPABASE_ANON_KEY
  ...
  if (!hasUrl || !hasKey) {
    ...
    console.error('   Please configure NEXT_PUBLIC_BRAND_SUPABASE_URL and NEXT_PUBLIC_BRAND_SUPABASE_ANON_KEY in your .env.local file')
  } else {
    // Validate URL format
