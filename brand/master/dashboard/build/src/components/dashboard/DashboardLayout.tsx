        ...
        >
          {!isCollapsed && (
            <div className="dashboard-layout-sidebar-logo flex items-center gap-2">
              <img src="/star.svg" alt="Master" width={24} height={24} style={{ filter: 'brightness(0) invert(1)' }} />
              <h1 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>Master</h1>
            </div>
          )}
          {isCollapsed && (
            <div className="dashboard-layout-sidebar-logo-collapsed w-8 h-8 flex items-center justify-center">
              <img src="/star.svg" alt="Master" width={24} height={24} style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
          )}
          {isMobile ? (
